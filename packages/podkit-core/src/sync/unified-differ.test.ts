/**
 * Unit tests for the unified diff engine
 *
 * Tests the generic UnifiedDiffer that delegates to ContentTypeHandler.
 * Uses a minimal mock handler to verify the algorithm independent of
 * any specific content type.
 */

import { describe, expect, it } from 'bun:test';
import { UnifiedDiffer, createUnifiedDiffer } from './unified-differ.js';
...
describe('UnifiedDiffer', () => {
  describe('empty collections', () => {
    it('should return empty diff for empty source and device', () => {
      const differ = new UnifiedDiffer(createMockHandler());
  ...
  describe('createUnifiedDiffer factory', () => {
    it('should create a working UnifiedDiffer instance', () => {
      const differ = createUnifiedDiffer(createMockHandler());
