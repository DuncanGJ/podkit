...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Page covers iOpenPod, Tunes Reloaded, Rhythmbox, and Strawberry Music Player
- [ ] #2 Each project has a brief description, key strengths, and a link
- [ ] #3 Includes a short podkit differentiators section (high-level, not a feature matrix)
- [ ] #4 Tone is supportive and helps users pick the right tool
- [ ] #5 Page has Starlight-compatible frontmatter
- [ ] #6 Documentation Map in AGENTS.md is updated with the new page
<!-- AC:END -->
