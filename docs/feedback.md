...
Found something broken? [Open an issue on GitHub](https://github.com/jvgomg/podkit/issues/new) with:
...
Using podkit in an interesting way? Modded iPod? Unusual setup? I'd genuinely love to see it. Share your setup in [Show and Tell](https://github.com/jvgomg/podkit/discussions/categories/show-and-tell).
